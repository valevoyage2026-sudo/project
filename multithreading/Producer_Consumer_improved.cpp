...
int main()
{
    ...
    // 4. Safely update the shared state under the lock scope
    {
        ...
        tasks.push([page]{LOG("task Proceessing:extracting text from page:"<<page);});
        tasks.push([page]{LOG("task Proceessing:extracting table from page:"<<page);});
        tasks.push([page]{LOG("task Proceessing:extracting image data from page:"<<page);});
        tasks.push([page]{LOG("task Proceessing:creating summary of  page:"<<page);});
